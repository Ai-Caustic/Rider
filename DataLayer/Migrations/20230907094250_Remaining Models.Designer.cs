...
namespace DataLayer.Migrations
{
    ...
    [Migration("20230907094250_Remaining Models")]
            ...
            modelBuilder.Entity("DomainLayer.Models.User", b =>
                {
                    ...
                    b.HasAlternateKey("Email", "IdNumber", "PhoneNumber");
            ...
            modelBuilder.Entity("DomainLayer.Models.Payment", b =>
                {
                    ...
                    b.HasOne("DomainLayer.Models.User", "User")
                        .WithOne("Payment")
                        .HasForeignKey("DomainLayer.Models.Payment", "UserId");
            ...
            modelBuilder.Entity("DomainLayer.Models.Ride", b =>
                {
                    b.HasOne("DomainLayer.Models.Driver", "Driver")
                        .WithOne("Ride")
                        .HasForeignKey("DomainLayer.Models.Ride", "DriverId");

                    b.HasOne("DomainLayer.Models.User", "User")
                        .WithOne("Ride")
                        .HasForeignKey("DomainLayer.Models.Ride", "UserId");
            ...
            modelBuilder.Entity("DomainLayer.Models.Vehicle", b =>
                {
                    b.HasOne("DomainLayer.Models.Driver", "Driver")
                        .WithOne("Vehicle")
                        .HasForeignKey("DomainLayer.Models.Vehicle", "DriverId");
